...
<body data-offset="40" background="img/carrito.jpg" style="background-attachment: fixed">
<div class="container">
<header class="header">
<div class="row">
</div>
...
<footer class="footer">
<hr class="soften"/>
<p>&copy; Copyright Juan David, Maronis Martinez, Victor villada y Leiver Ricardo <br/><br/></p>
 </footer>
</div><!-- /container -->
    <!-- Le javascript
    ================================================== -->
